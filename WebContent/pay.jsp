...
<div class="am-container header">
    ...
    <ul class="message-r">
        ...
        <div class="topMessage mini-cart">
            <div class="menu-hd"><a id="mc-menu-hd" href="cart.jsp" target="_top"><i
            ...
            <ul>
                ...
                <li class="user-addresslist defaultAddr">
                   ...
                   <span class="buy-user">艾迪 </span>
										<span class="buy-phone">158xxxxxxxx</span>
										</span>
                        </div>
                        <div class="default-address DefaultAddr">
                            ...
                            <span class="buy--address-detail">
								   <span class="province">湖北</span>省
										...
										<span class="street">雄楚大道xxxxx</span>
										</span>
                        ...
                        <div class="default-address DefaultAddr">
                            ...
                            <span class="buy--address-detail">
								   <span class="province">湖北</span>省
										...
										<span class="street">东湖路xxxx</span>
										</span>
        ...
        <div class="concent">
            <div id="payTable">
                ...
                <%
                    ...
                    System.out.println("========================================");
                    System.out.println("[pay.jsp] ===== Payment Page Loaded =====");
                    System.out.println("[pay.jsp] Cart in session: " + (cart == null ? "null" : cart.size() + " items"));
                    
                    if (cart != null && !cart.isEmpty()) {
                        for (Map.Entry<String, CartItem> entry : cart.entrySet()) {
                            CartItem item = entry.getValue();
                            Product p = item.getP();
                            int quantity = item.getSum();
                            double itemTotal = p.getPrice() * quantity;
                            totalAmount += itemTotal;
                            totalCount += quantity;
                            
                            System.out.println("[pay.jsp] Product: " + p.getName() + ", Price: " + p.getPrice() + ", Quantity: " + quantity + ", Subtotal: " + itemTotal);
                %>
                        ...
                        <div class="bundle-main">
                            <ul class="item-content clearfix">
                                <div class="pay-phone">
                                    <li class="td td-item">
                                        <div class="item-pic">
                                            <a href="detail.jsp?id=<%=p.getId()%>" class="J_MakePoint">
                                                <img src="images/<%=p.getImg()%>" class="itempic J_ItemImg"></a>
                                        </div>
                                        <div class="item-info">
                                            <div class="item-basic-info">
                                                <a href="detail.jsp?id=<%=p.getId()%>" class="item-title J_MakePoint" data-point="tbcart.8.11"><%=p.getName()%></a>
                                            </div>
                                        </div>
                                    </li>
                                    <li class="td td-price">
                                        <div class="item-price price-promo-promo">
                                            <div class="price-content">
                                                <em class="J_Price price-now"><%=String.format("%.2f", p.getPrice())%></em>
                                            </div>
                                        </div>
                                    </li>
                                </div>
                                <li class="td td-amount">
                                    <div class="amount-wrapper ">
                                        <div class="item-amount ">
                                            ...
                                            <div class="sl">
                                                <input class="min am-btn" name="" type="button" value="-" disabled/>
                                                <input class="text_box" name="" type="text" value="<%=quantity%>"
                                                       style="width:30px;" readonly/>
                                                <input class="add am-btn" name="" type="button" value="+" disabled/>
                                            </div>
                                        </div>
                                    </div>
                                </li>
                                <li class="td td-sum">
                                    <div class="td-inner">
                                        <em tabindex="0" class="J_ItemSum number"><%=String.format("%.2f", itemTotal)%></em>
                                    </div>
                                </li>
                ...
                <%
                        ...
                        System.out.println("[pay.jsp] Total Amount: " + totalAmount);
                        System.out.println("[pay.jsp] Total with shipping: " + (totalAmount + 10));
                        System.out.println("========================================");
                    } else {
                %>
                <div align="center" style="margin:50px">
                    <font color="red" size=5>购物车中没有商品，请先添加商品到购物车</font>
                </div>
                <%
                    }
                %>
            ...
            <div class="buy-point-discharge ">
                <%
                    double finalAmount = totalAmount + 10;
                %>
                <p class="price g_price ">
                    合计（含运费） <span>¥</span><em class="pay-sum"><%=String.format("%.2f", finalAmount)%></em>
                </p>
            </div>
                ...
                <div class="pay-confirm clearfix">
                    <div class="box">
                        <div tabindex="0" id="holyshit267" class="realPay"><em class="t">实付款：</em>
                            <span class="price g_price ">
                                    <span>¥</span> <em class="style-large-bold-red " id="J_ActualFee"><%=String.format("%.2f", finalAmount)%></em>
											</span>
                        </div>
                            ...
                            <p class="buy-footer-address">
                                ...
                                <span class="buy--address-detail">
								   <span class="province">湖北</span>省
												<span class="city">武汉</span>市
												<span class="dist">洪山</span>区
												<span class="street">雄楚大道xxxx</span>
												</span>
                            </span>
                            </p>
                            <p class="buy-footer-address">
                                ...
                                <span class="buy-address-detail">
                                         <span class="buy-user">艾迪 </span>
												<span class="buy-phone">158xxxxxxx</span>
												</span>
                            </p>
                        </div>
                    </div>
                    ...
                    <div id="holyshit269" class="submitOrder">
                        <div class="go-btn-wrap">
                            <%
                                // Save order amount to session for success page
                                session.setAttribute("orderAmount", finalAmount);
                                System.out.println("[pay.jsp] Order amount saved to session: " + finalAmount);
                            %>
