<%@ page language="java" import="dao.*,entity.*" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8" %>
<!DOCTYPE html>
        ...
        <div class="clearfixLeft" id="clearcontent">
            ...
            <div class="box">
                ...
                <div class="tb-booth tb-pic tb-s310">
                    ...
                    <a href="images/01.jpg"><img src="images/small-<%= p.getImg() %>" alt="细节展示放大镜特效"
                                                 rel="images/large-<%= p.getImg() %>" class="jqzoom"/></a>
            ...
            <div class="tb-detail-list">
                ...
                <div class="tb-detail-price">
                    <li class="price iteminfo_price">
                        <dt>促销价</dt>
                        <dd><em>¥</em><b class="sys_item_price"><%= p.getPrice() %>
                        </b></dd>
                    </li>
