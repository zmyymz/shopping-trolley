...
<%--						%>--%>
			...
			<div class="nav white">
				...
				<div class="logoBig">
					<li><a href="list.jsp"><img src="images/logobig.png" /></a></li>
				</div>
								...
								<ul class="item-content clearfix">
									...
									<li class="td td-item">
										<div class="item-pic">
											...
											<a href="#" target="_blank" data-title="dsfasdf" class="J_MakePoint" data-point="tbcart.8.12">
												<img src="images/80x80-<%= p.getImg() %>" class="itempic J_ItemImg"></a>
										</div>
										<div class="item-info">
											<div class="item-basic-info">
												<a href="#" target="_blank" title="美康粉黛醉美唇膏 持久保湿滋润防水不掉色" class="item-title J_MakePoint" data-point="tbcart.8.11"><%= p.getName()%></a>
											</div>
										</div>
									</li>
									<li class="td td-info">
