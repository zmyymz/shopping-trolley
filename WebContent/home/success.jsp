...
<div class="am-container header">
  ...
  <ul class="message-r">
    ...
    <div class="topMessage mini-cart"><div class="menu-hd"><a id="mc-menu-hd" href="cart.jsp" target="_top"><i class="am-icon-shopping-cart  am-icon-fw"></i><span>购物车</span><strong id="J_MiniCartNum" class="h">0</strong></a></div></div>
...
<%
    ...
    if (orderAmount == null) {
        ...
        orderAmount = totalAmount + 10; // 加上运费
    }
    
    System.out.println("========================================");
    System.out.println("[success.jsp] ===== Order Success =====");
    System.out.println("[success.jsp] Order Amount: " + orderAmount);
    System.out.println("========================================");
...
<div class="take-delivery">
 <div class="status">
   ...
   <div class="successInfo">
     <ul>
       <li>付款金额<em>¥<%=String.format("%.2f", orderAmount)%></em></li>
       <div class="user-info">
         <p>收货人：艾迪</p>
         <p>联系电话：158xxxxxxxx</p>
         <p>收货地址：湖北省 武汉市 武昌区 东湖路xxxxx</p>
       </div>
